	<html>
<head>
	<title> Update – Student database management system </title>
...
<?php 
	...
	{	
		...
		<form name=update  class=after method=POST action="http://localhost/Project/update1.php">
			<center> Select the roll number to be updated <br>
		<select name=roll>
